...
# Tag Docker Image
docker tag pulse-backend:7.2 260939427961.dkr.ecr.us-west-2.amazonaws.com/pulse-backend:7.2

# Push Docker Image to ECR
docker push 260939427961.dkr.ecr.us-west-2.amazonaws.com/pulse-backend:7.2
