...
# Tag Docker Image
docker tag pulse-backend:4.8 260939427961.dkr.ecr.us-west-2.amazonaws.com/pulse-backend:4.8

# Push Docker Image to ECR
docker push 260939427961.dkr.ecr.us-west-2.amazonaws.com/pulse-backend:4.8
